...
const size = 20;
const bwidth = 2;
const mazeHeight = 200 * (4 /2);
const mazeWidth = 300 * (4 /3);

document.getElementById('bottom').setAttribute('style','top:'+(mazeHeight+step)+'px;width:'+(mazeWidth)+'px;')
document.getElementById('top').setAttribute('style','width:'+(mazeWidth)+'px')

document.getElementById('maze').setAttribute('style','height:'+(mazeHeight+step+20)+'px;width:'+(mazeWidth+step+20)+'px;')
